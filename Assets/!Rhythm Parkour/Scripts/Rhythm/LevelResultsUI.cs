...
{
    public class LevelResultsUI : RKSBehaviour
    {
        ...
        [InjectOptional] public PlayerHealth playerHealth;
        [InjectOptional] public LevelTransfer transfer;
        [InjectOptional] public MenuController menu;
        ...
        protected override void OnReady() => BindIfNeeded();
        ...
        protected override void Update()
        {
            ...
            if (_resultsVisible)
            {
                ...
                if (menu != null && menu.IsMenuActive)
                {
                    HideResultsImmediate();
                }
        ...
        private void ShowResults(LevelResults r)
        {
            ...
            if (_editorButton) _editorButton.gameObject.SetActive(transfer != null && transfer.fromEditor);
        ...
        public void Retry()
        {
            ...
            else if (parkour != null) parkour.Play();
        ...
        public void OpenEditor()
        {
            ...
            string target = transfer != null && !string.IsNullOrEmpty(transfer.sourceScene) ? transfer.sourceScene : "IsLevelEditorScene";
            if (Transition != null) Transition.LoadScene(target);
