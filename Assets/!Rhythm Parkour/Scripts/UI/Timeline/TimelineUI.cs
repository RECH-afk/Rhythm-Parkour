...
namespace RKS.RhythmParkour.UI.Timeline
{
    ...
    public class TimelineUI : RKSBehaviour
    {
        ...
        protected override void OnInjected()
        {
            ...
            if (autoscrollToggleButton == null || previewToggleButton == null)
                Debug.LogWarning("[TimelineUI] Кнопки скролла/превью не назначены — задай в инспекторе.", this);
        ...
        void EnsurePrefabGrid()
        {
            ...
            if (choosePrefabButton == null)
            {
                ...
                Debug.LogWarning("[TimelineUI] choosePrefabButton не назначен — задай в инспекторе.", this);
            }
            if (choosePrefabButton != null)
            {
                choosePrefabButton.onClick.RemoveListener(TogglePrefabGrid);
